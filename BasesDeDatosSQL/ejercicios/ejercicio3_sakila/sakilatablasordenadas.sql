-- CREACIÓN ORDENADA DE LAS TABLAS SAKILA CON FKs FUNCIONALES
...
-- 2. Tabla city (depende de country)
CREATE TABLE city (
...
-- 3. Tabla address (depende de city)
...
-- 4. Tabla language (independiente)
...
-- 6. Tabla category (independiente)
...
-- 7. Tabla staff (crear sin FKs para evitar dependencia circular con store)
CREATE TABLE staff (
...
-- 8. Tabla store (crear sin FKs también)
CREATE TABLE store (
...
-- AÑADIR LAS FK QUE FALTAN A staff Y store
ALTER TABLE staff
